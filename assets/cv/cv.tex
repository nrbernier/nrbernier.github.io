...
\personalinfo{%
  ...
  % \orcid{orcid.org/0000-0000-0000-0000}
    ...
    %{\color{accent}\href{https://nrbernier.github.io/}{nrbernier.github.io}} 
}
...
\timelineperiods{
    {2020}/{% Personal projects
        \cvevent{Data Science Projects in Freelance}%
        {Personal Website: \href{https://nrbernier.github.io/}{nrbernier.github.io}}
        {}{}
        %\lpqm
        \begin{itemize}
            \item{
                \href{https://nrbernier.github.io/projects/swiss_beers_map/}
            {Interactive map} of Swiss breweries from web scraping} 
            \item{
                \href{https://nrbernier.github.io/projects/wine_reviews/}
                {Predicting  wine-review scores} with machine learning}
        \end{itemize}
    },
    2019/{% Postdoc
        ...
        \begin{itemize}
            ...
            \item{%Creation of a m
                Module to model data by Bayesian inference}
        \end{itemize}
    },
    2014/
    {% PhD
        ...
        {4.5 years}{}
        %\lpqm \\
        Design and signal processing of
        superconducting 
        %Cryogenic
        microwave circuits
        ...
        \smallskip
        \begin{itemize}
        \item{Responsible for data analysis and visualization in Python}
